...
const WhyHireMe: React.FC = () => {
  ...
  return (
    <section className="bg-brand-gray dark:bg-brand-dark-2 rounded-3xl p-8 md:p-12 my-20">
      <div className="grid md:grid-cols-2 gap-12 items-center">
        ...
        <AnimatedSection animation="fade-in-right" delay={200}>
          <div>
            ...
            <a href="#contact" onClick={handleNavClick} className="inline-block mt-10 bg-white dark:bg-brand-dark border border-gray-300 dark:border-gray-600 text-brand-dark dark:text-white px-8 py-3 rounded-full font-semibold hover:bg-gray-100 dark:hover:bg-gray-800 transition-all duration-300 transform hover:scale-105 hover:-translate-y-1">
              Hire me
            </a>
          </div>
        </AnimatedSection>
