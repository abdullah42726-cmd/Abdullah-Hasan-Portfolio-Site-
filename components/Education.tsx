    ...
    <section className="py-20 text-left">
      ...
      <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-12">
        ...
        <AnimatedSection delay={300}>
          <div className="p-8 rounded-lg bg-brand-gray dark:bg-brand-dark-2 shadow-md hover:shadow-xl transition-shadow duration-300 h-full">
            <h3 className="text-2xl font-bold text-brand-dark dark:text-white">SSC (Science)</h3>
            <p className="text-gray-600 dark:text-gray-400 mt-2">Kuptala Adarsha High School</p>
            <p className="text-gray-500 dark:text-gray-500 text-sm mt-1">Passing Year: 2016</p>
        ...
        <AnimatedSection delay={400}>
          <div className="p-8 rounded-lg bg-brand-gray dark:bg-brand-dark-2 shadow-md hover:shadow-xl transition-shadow duration-300 h-full">
            <h3 className="text-2xl font-bold text-brand-dark dark:text-white">JSC (General)</h3>
            <p className="text-gray-600 dark:text-gray-400 mt-2">Kuptala Adarsha High School</p>
            <p className="text-gray-500 dark:text-gray-500 text-sm mt-1">Passing Year: 2013</p>
