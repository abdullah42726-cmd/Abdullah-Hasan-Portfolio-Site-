...
const ServiceCard: React.FC<ServiceCardProps> = ({ service, index, onClick }) => (
  <div 
    ...
    role="button"
    tabIndex={0}
    className="bg-brand-dark-2 rounded-3xl p-8 h-full flex flex-col group transition-all duration-300 hover:scale-105 hover:-translate-y-2 hover:shadow-2xl hover:shadow-brand-blue-500/10 border border-transparent hover:border-brand-blue-500/30 cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-brand-dark focus:ring-brand-blue-500"
